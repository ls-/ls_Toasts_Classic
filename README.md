...
If you found a bug or want to share an idea on how to improve my addon, either use the issue tracker on [GitHub](https://github.com/ls-/ls_Toasts_Classic/issues) or join our [Discord](https://discord.gg/7QcJgQkDYD) server.
...
Please see [LICENSE](https://github.com/ls-/ls_Toasts_Classic/blob/master/LICENSE.txt) file.
