...
-- L["GROWTH_DIR_DOWN"] = _G.HUD_EDIT_MODE_SETTING_AURA_FRAME_ICON_DIRECTION_DOWN -- not in vanilla
-- L["GROWTH_DIR_LEFT"] = _G.HUD_EDIT_MODE_SETTING_AURA_FRAME_ICON_DIRECTION_LEFT -- not in vanilla
-- L["GROWTH_DIR_RIGHT"] = _G.HUD_EDIT_MODE_SETTING_AURA_FRAME_ICON_DIRECTION_RIGHT -- not in vanilla
-- L["GROWTH_DIR_UP"] = _G.HUD_EDIT_MODE_SETTING_AURA_FRAME_ICON_DIRECTION_UP -- not in vanilla
L["ID"] = _G.ID
L["ILVL"] = _G.LFG_LIST_ITEM_LEVEL_INSTR_SHORT
-- L["IMPORT"] = _G.HUD_EDIT_MODE_IMPORT_LAYOUT -- not available in vanilla
...
-- L["SIZE"] = _G.HUD_EDIT_MODE_SETTING_MINIMAP_SIZE -- not in vanilla
