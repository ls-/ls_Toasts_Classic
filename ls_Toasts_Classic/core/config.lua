...
local GITHUB_LINK = "https://github.com/ls-/ls_Toasts_Classic"
local WAGO_LINK = "https://addons.wago.io/addons/ls-toasts-classic"
...
do
	...
	editBox:SetScript("OnKeyUp", function(_, key)
		if IsControlKeyDown() and (key == "C" or key == "X") then
			ActionStatus_DisplayMessage(getStatusMessage(), true)
...
do
	...
	local function createHeader(parent, text)
		...
		header:SetScript("OnHyperlinkEnter", nil)
		header:SetScript("OnHyperlinkLeave", nil)
	...
	function addon:CreateBlizzConfig()
		...
		supportContainer:AddButton("Interface\\AddOns\\ls_Toasts_Classic\\assets\\discord-64", L["DISCORD"], DISCORD_LINK)
		supportContainer:AddButton("Interface\\AddOns\\ls_Toasts_Classic\\assets\\github-64", L["GITHUB"], GITHUB_LINK)
		...
		-- downloadContainer:AddButton("Interface\\AddOns\\ls_Toasts_Classic\\assets\\mmoui-64", L["WOWINTERFACE"])
		downloadContainer:AddButton("Interface\\AddOns\\ls_Toasts_Classic\\assets\\curseforge-64", L["CURSEFORGE"], CURSE_LINK)
		downloadContainer:AddButton("Interface\\AddOns\\ls_Toasts_Classic\\assets\\wago-64", L["WAGO"], WAGO_LINK)
