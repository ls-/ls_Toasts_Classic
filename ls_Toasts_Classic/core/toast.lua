...
local function constructToast()
	...
	textBG:SetTexture("Interface\\AddOns\\ls_Toasts_Classic\\assets\\text-bg")
	...
	do
		...
		leafTL:SetTexture("Interface\\AddOns\\ls_Toasts_Classic\\assets\\toast-overlay-leaves")
		...
		leafTR:SetTexture("Interface\\AddOns\\ls_Toasts_Classic\\assets\\toast-overlay-leaves")
		...
		leafBR:SetTexture("Interface\\AddOns\\ls_Toasts_Classic\\assets\\toast-overlay-leaves")
